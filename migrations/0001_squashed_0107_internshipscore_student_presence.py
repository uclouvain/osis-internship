    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acronym', models.CharField(default=' ', max_length=125)),
                ('uuid', models.UUIDField(db_index=True, default=uuid.uuid4, editable=False, unique=True)),
                ('cohort', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='internship.Cohort')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('selectable', models.BooleanField(default=True)),
                ('speciality', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='internship.InternshipSpeciality')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='internship.Period')),
                ('place', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='internship.Organization')),
                ('student', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='base.Student')),
