...
class LearningUnitYear(SerializableModel):
    ...
    type = models.CharField(max_length=20, blank=True, null=True, choices=learning_unit_year.LEARNING_UNIT_YEAR_TYPES)
    credits = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)
    decimal_scores = models.BooleanField(default=False)
    team = models.BooleanField(default=False)
    vacant = models.BooleanField(default=False)
    in_charge = models.BooleanField(default=False)
    status=models.CharField(max_length=20, blank=True, null=True, choices=learning_unit_year.LEARNING_UNIT_YEAR_STATUS)
