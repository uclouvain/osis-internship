...
urlpatterns = [
    ...
    url(r'^studies/assessments/scores_encoding/paper_sheet/([0-9]+)/$', score_encoding.paper_sheet, name='paper_sheet'),
    ...
    url(r'^studies/assessments/scores_encoding/online/(?P<learning_unit_year_id>[0-9]+)(?:/(?P<tutor_id>[0-9]+))?/double_validation$', score_encoding.online_double_encoding_validation, name='online_double_encoding_validation'),
