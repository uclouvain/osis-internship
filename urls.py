    ...
    url(r'^cohorts/', include([
        ...
        url(r'^(?P<cohort_id>[0-9]+)/', include([
            ...
            url(r'^scores_encoding/', include([
                ...
                url(r'^edit/(?P<student_registration_id>[0-9]+)/(?P<period_id>[0-9]+)$', score.score_detail_form,
            ...
            url(r'^internship_evaluation/', include([
                ...
                url(r'^results/$', place_evaluation.internship_place_evaluation_results, name='place_evaluation_results'),
