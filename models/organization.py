...
class Organization(SerializableModel):
    ...
    report_specialty = models.IntegerField(default=6, blank=True, null=True)
    report_birthdate = models.IntegerField(default=7, blank=True, null=True)
    report_email = models.IntegerField(default=8, blank=True, null=True)
    report_noma = models.IntegerField(default=9, blank=True, null=True)
    report_phone = models.IntegerField(default=10, blank=True, null=True)
    report_address = models.IntegerField(default=11, blank=True, null=True)
    report_postal_code = models.IntegerField(default=12, blank=True, null=True)
    report_city = models.IntegerField(default=13, blank=True, null=True)
    report_master = models.IntegerField(default=14, blank=True, null=True)
