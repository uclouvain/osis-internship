...
class Organization(SerializableModel):
    ...
    report_gender = models.IntegerField(default=6, blank=True, null=True, verbose_name=_('Report gender'))
    report_specialty = models.IntegerField(default=7, blank=True, null=True, verbose_name=_('Report specialty'))
    report_birthdate = models.IntegerField(default=8, blank=True, null=True, verbose_name=_('Report birthdate'))
    report_email = models.IntegerField(default=9, blank=True, null=True, verbose_name=_('Report email'))
    report_noma = models.IntegerField(default=10, blank=True, null=True, verbose_name=_('Report noma'))
    report_phone = models.IntegerField(default=11, blank=True, null=True, verbose_name=_('Report phone'))
    report_address = models.IntegerField(default=12, blank=True, null=True, verbose_name=_('Report address'))
    report_postal_code = models.IntegerField(default=13, blank=True, null=True, verbose_name=_('Report postal code'))
    report_city = models.IntegerField(default=14, blank=True, null=True, verbose_name=_('Report city'))
    report_master = models.IntegerField(default=15, blank=True, null=True, verbose_name=_('Report master'))
