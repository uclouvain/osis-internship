...
https://www.jetbrains.com/pycharm/[PyCharm] is python JetBrains IDE. +
The community edition does not work out of the box with Django, but it is helpful for the pep8 code formating, completion,... +

==== Download and install PyCharm community edition
Download and install PyCharm following the instructions on the web site : https://www.jetbrains.com/pycharm/

==== Configuration of PyCharm to code OSIS project
===== Configure the python interpreter
1. Open OSIS project.
2. Select `File -> Settings -> Project:osis -> Project Interpreter` .
3. Click on the wheel at the top right , and choose `add Local` .
4. Navigate to the python3.4 binary in your virtual environment (`$VENV/lib/python3.4`).

image::images/pycharm_osis_config_1.png["Pycharm VENV config",width=128,link="/images/pycharm_osis_config_1.png"]

===== Configure the Django server to debug OSIS through PyCharm
[NOTE]
====
Running the application output an error :
...
2. Click on the `+` buton and add a python script.
3. Fill in the name.
...
image::images/pycharm_osis_config_2.png["Pycharm VENV config",width=128,link="/images/pycharm_osis_config_2.png"]
