...
* **Gestionnaire des stages**: L'accès est limité à l'application back office.
* **Étudiant**: L'accès est limité à l'application front office.
* **Administrateur**: Accès à l'administration des données bruts pour la résolution des problèmes non anticipés.
