...
urlpatterns = [
    ...
    url(r'^cohort/(?P<cohort_id>[0-9]+)/', include([
        ...
        url(r'^offers/', include([
            ...
            url(r'^(?P<offer_id>[0-9]+)/students/choice/$', internship.student_choice, name='internship_detail_student_choice'),
            url(r'^block/$', internship.internships_block, name='internships_block'),
            url(r'^save/$', internship.internships_save, name='internships_save'),
            url(r'^save/modification/student/$', internship.internship_save_modification_student, name='internship_save_modification_student'),
            url(r'^std/$', internship.internships_stud, name='internships_stud'),
        ])),
    ...
    url(r'^students/', include([
        url(r'^([0-9]+)/', include([
            url(r'^affectation/modification/$', student_resume.internship_student_affectation_modification, name='internship_student_affectation_modification'),
            url(r'^information/modification/$', student_resume.internship_student_information_modification, name='internship_student_information_modification'),
