...
def speciality_save(request, speciality_id):
    if speciality_id:
        check_speciality = mdl_internship_speciality.find_by_id(speciality_id)
        if check_speciality :
            speciality = check_speciality
        else :
            speciality = mdl_internship_speciality.InternshipSpeciality()
    else :
        speciality = mdl_internship_speciality.InternshipSpeciality()
...
def speciality_delete(request, speciality_id):
    mdl_internship_speciality.InternshipSpeciality.objects.filter(pk=speciality_id).delete()
    return HttpResponseRedirect(reverse('internships_specialities'))
