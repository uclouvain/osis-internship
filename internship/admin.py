...
class InternshipMasterAdmin(admin.ModelAdmin):
    list_display = ('reference', 'organization', 'person', 'civility', 'type_mastery', 'speciality')
    fieldsets = ((None, {'fields': ('reference', 'organization', 'person', 'civility', 'type_mastery', 'speciality')}),)
