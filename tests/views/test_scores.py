...
class ScoresEncodingTest(TestCase):
    ...
    @mock.patch('internship.views.score.send_score_encoding_callback')
    def test_send_callback(self, mock_send_mail):
