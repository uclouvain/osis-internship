...
def search_scores_responsible(learning_unit_title, course_code, attributions_list, entity, tutor, scores_responsible):
    ...
    if attributions_list:
        entities_list = [attribution for attribution in attributions_list]
